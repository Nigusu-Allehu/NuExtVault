...
public sealed class OfficialAssemblySplitFitnessTests
{
    ...
    private const string FixtureAssembly = "NuGet.TestServer.RouteFixture";
    ...
    [
        ("builtin.flat-container",
            "NuGet.TestServer.Extensions.FlatContainer.FlatContainerModule"),
        ("builtin.operations",
            "NuGet.TestServer.Extensions.Operations.OperationsModule"),
        ("builtin.package-management",
            "NuGet.TestServer.Extensions.PackageManagement.PackageManagementModule"),
        ("builtin.registration",
            "NuGet.TestServer.Extensions.Registration.RegistrationModule"),
        ("builtin.search",
            "NuGet.TestServer.Extensions.Search.SearchModule"),
        ("NuTest.SupplyChain",
            "NuGet.TestServer.Extensions.SupplyChain.SupplyChainExtension"),
        ("builtin.service-index",
            "NuGet.TestServer.Extensions.ServiceIndex.ServiceIndexOperations"),
        ("builtin.test-control",
            "NuGet.TestServer.Extensions.Control.ControlOperations"),
        ("builtin.vulnerabilities",
            "NuGet.TestServer.Extensions.Vulnerabilities.VulnerabilityOperations")
    ];
    ...
    public void Project_references_form_a_one_way_graph()
    {
        ...
        Assert.Equal([BootstrapAssembly], ProjectReferences("NuGet.TestServer.Cli"));
