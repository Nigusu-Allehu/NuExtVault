...
using NuExtVault.ForbiddenReferenceFixture;
...
/// <c>Contoso.NuExtVault.Flavors</c> fixture
/// (tests/NuExtVault.SdkFixture) supplies the one genuinely loadable entry
...
public sealed class ExternalExtensionPackageLoaderTests(ExternalExtensionAssetsFixture fixture)
{
    ...
    public void A_correctly_signed_package_from_a_trusted_root_loads_successfully()
    {
        ...
        Assert.Contains("NuExtVault.SdkFixture", identity.ModuleAssemblyIdentity);
    ...
    public void An_attestation_that_fails_verification_is_rejected(string variant, string expectedFailureCode)
    {
        ...
        nupkg = variant switch
        {
            ...
            "wrong-identity" => ReplaceAttestation(nupkg, key, packageId: "Contoso.NuExtVault.NotFlavors"),
    ...
    public void More_packages_than_the_configured_count_limit_are_rejected()
    {
        ...
        roots.WritePackage(
            "a.nupkg",
            ExternalExtensionPackageBuilder.BuildCompanionPackage(
                Assets, "Contoso.NuExtVault.FlavorsA", "1.0.0", key));
        roots.WritePackage(
            "b.nupkg",
            ExternalExtensionPackageBuilder.BuildCompanionPackage(
                Assets, "Contoso.NuExtVault.FlavorsB", "1.0.0", key));
    ...
    public void A_dependency_whose_declared_range_excludes_the_present_version_is_rejected()
    {
        ...
        roots.WritePackage(
            "dependency.nupkg",
            ExternalExtensionPackageBuilder.BuildCompanionPackage(
                Assets, "Contoso.NuExtVault.Dependency", "2.0.0", key));
        roots.WritePackage(
            "flavors.nupkg",
            ExternalExtensionPackageBuilder.BuildValidPackage(
                Assets,
                ...
                extensionDependencies:
                [
                    new ExternalExtensionDependencySpec("Contoso.NuExtVault.Dependency", "1.0.0", "2.0.0")
                ]));
    ...
    public void A_cycle_between_two_extension_dependencies_is_rejected()
    {
        ...
        roots.WritePackage(
            ...
            ExternalExtensionPackageBuilder.BuildCompanionPackage(
                Assets,
                "Contoso.NuExtVault.CycleA",
                "1.0.0",
                key,
                extensionDependencies:
                [
                    new ExternalExtensionDependencySpec("Contoso.NuExtVault.CycleB", "1.0.0", "2.0.0")
                ]));
        roots.WritePackage(
            "b.nupkg",
            ExternalExtensionPackageBuilder.BuildCompanionPackage(
                Assets,
                "Contoso.NuExtVault.CycleB",
                "1.0.0",
                key,
                extensionDependencies:
                [
                    new ExternalExtensionDependencySpec("Contoso.NuExtVault.CycleA", "1.0.0", "2.0.0")
                ]));
    ...
    public void Dependency_load_order_is_deterministic_and_topologically_sorted()
    {
        ...
        roots.WritePackage(
            ...
            ExternalExtensionPackageBuilder.BuildCompanionPackage(
                Assets,
                "Contoso.NuExtVault.OrderA",
                "1.0.0",
                key,
                extensionDependencies:
                [
                    new ExternalExtensionDependencySpec("Contoso.NuExtVault.OrderB", "1.0.0", "2.0.0")
                ]));
        roots.WritePackage(
            "b.nupkg",
            ExternalExtensionPackageBuilder.BuildCompanionPackage(
                Assets, "Contoso.NuExtVault.OrderB", "1.0.0", key));
    ...
    public void A_manifest_that_claims_a_kernel_owned_operation_id_is_rejected()
    {
        ...
        roots.WritePackage(
            ...
            ExternalExtensionPackageBuilder.BuildCompanionPackage(
                Assets,
                "Contoso.NuExtVault.OperationSquatter",
                "1.0.0",
                key,
    ...
    public void A_manifest_that_claims_a_kernel_owned_route_path_is_rejected()
    {
        ...
        roots.WritePackage(
            ...
            ExternalExtensionPackageBuilder.BuildCompanionPackage(
                Assets,
                "Contoso.NuExtVault.RouteSquatter",
                "1.0.0",
                key,
    ...
    public void A_manifest_that_claims_a_kernel_owned_service_index_resource_kind_is_rejected()
    {
        ...
        roots.WritePackage(
            ...
            ExternalExtensionPackageBuilder.BuildCompanionPackage(
                Assets,
                "Contoso.NuExtVault.ResourceSquatter",
                "1.0.0",
                key,
    ...
    public void An_entry_assembly_that_references_the_host_kernel_or_official_assembly_is_rejected()
    {
        ...
        var manifestBytes = MinimalManifestJson.Build(
            "Contoso.NuExtVault.Forbidden", "1.0.0", "Contoso");
        var packageJson = ExternalExtensionPackageJson.Build(
            "NuExtVault.ForbiddenReferenceFixture.dll",
            typeof(ForbiddenReferenceExtension).FullName!,
            []);
        var payload = ConformanceAttestationFixture.BuildPayload(
            "Contoso.NuExtVault.Forbidden",
            "1.0.0",
            "Contoso",
        ...
        var nupkg = ExternalExtensionPackageBuilder.BuildNupkg(
            ...
            new Dictionary<string, byte[]>
            {
                ["NuExtVault.ForbiddenReferenceFixture.dll"] = forbiddenAssemblyBytes
            });
    ...
    public void Diagnostics_are_ordered_by_package_identity_regardless_of_write_order()
    {
        ...
        roots.WritePackage(
            "z.nupkg",
            ExternalExtensionPackageBuilder.BuildCompanionPackage(
                Assets, "Contoso.NuExtVault.Zed", "1.0.0", key));
        roots.WritePackage(
            "a.nupkg",
            ExternalExtensionPackageBuilder.BuildCompanionPackage(
                Assets, "Contoso.NuExtVault.Alpha", "1.0.0", key));
        ...
        var expectedOrder = new[] { "Contoso.NuExtVault.Alpha", "Contoso.NuExtVault.Zed" };
    ...
    public void A_package_added_after_load_is_invisible_until_the_next_restart_load()
    {
        ...
        roots.WritePackage(
            "companion.nupkg",
            ExternalExtensionPackageBuilder.BuildCompanionPackage(
                Assets, "Contoso.NuExtVault.LateArrival", "1.0.0", key));
