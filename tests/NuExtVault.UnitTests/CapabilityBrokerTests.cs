...
using NuExtVault.Kernel.Owners;
...
public sealed class CapabilityBrokerTests
{
    ...
    public void Owner_adapters_receive_capabilities_not_privileged_implementation_objects()
    {
        ...
        Type[] owners =
        [
            typeof(NuExtVault.Extensions.FlatContainer.FlatContainerOperations),
            ...
            typeof(NuExtVault.Extensions.Operations.OperationsOperations)
        ];
