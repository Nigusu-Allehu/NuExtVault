...
internal static class TestPaths
{
    ...
    public static string Fixture(string name) =>
        Path.Combine(RepositoryRoot, "tests", "NuExtVault.Extensions.Sdk.Tests", "Fixtures", name);

    public static string Snapshot(string name) =>
        Path.Combine(RepositoryRoot, "tests", "NuExtVault.Extensions.Sdk.Tests", "Snapshots", name);
