...
/// <c>NuExtVault.Extensions.Sdk.Tests.TestPaths</c>).
/// </summary>
public static class RepositoryPaths
{
    ...
    public static string ForbiddenReferenceFixtureProjectPath { get; } = Path.Combine(
        "tests",
        "NuExtVault.ForbiddenReferenceFixture",
        "NuExtVault.ForbiddenReferenceFixture.csproj");
    ...
    public static string PackageStagingProjectPath { get; } = Path.Combine(
        ...
        "NuExtVault.Extensions.PackageStaging.csproj");
