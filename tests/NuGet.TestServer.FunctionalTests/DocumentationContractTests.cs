...
public sealed partial class DocumentationContractTests
{
    ...
    public void Documentation_tests_have_one_dedicated_ci_owner()
    {
        ...
        Assert.Contains(
            "FullyQualifiedName~NuGet.TestServer.FunctionalTests.DocumentationContractTests|FullyQualifiedName~NuGet.TestServer.FunctionalTests.DocumentationExampleTests",
