...
public static class ExternalExtensionPackageBuilder
{
    ...
    /// <summary>Packs the real, separately compiled `Contoso.NuTestServer.Flavors`
    /// fixture (`tests/NuGet.TestServer.SdkFixture`) with `dotnet pack`, and returns
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        const string entryType = "NuGet.TestServer.SdkFixture.FlavorsExtension";
        ...
        if (result.ExitCode != 0)
        {
            throw new InvalidOperationException(
                $"Failed to pack the Contoso.NuTestServer.Flavors fixture:{Environment.NewLine}{result.Output}");
        }
