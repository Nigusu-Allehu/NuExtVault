...
namespace NuExtVault.PackageStaging;
...
{
    internal const string ExtensionId = "NuExtVault.PackageStaging";
    ...
    public void RegisterRoutes(IRouteBinderRegistry routes)
    {
        ...
        routes.Bind<CreateGroupRequest>(
            new RouteIdentity("nuextvault.staging.create-group"),
            static (request, _) =>
            {
        ...
        routes.Bind<UploadSymbolRequest>(
            new RouteIdentity("nuextvault.staging.upload-symbol"),
        ...
        routes.Bind<InspectRequest>(
            new RouteIdentity("nuextvault.staging.inspect"),
        ...
        routes.Bind<PromoteRequest>(
            new RouteIdentity("nuextvault.staging.promote"),
        ...
        routes.Bind<RejectRequest>(
            new RouteIdentity("nuextvault.staging.reject"),
