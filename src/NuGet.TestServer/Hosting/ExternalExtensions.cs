...
internal static class ExternalExtensionPackageLoader
{
        ...
        ExternalExtensionLimits limits)
    {
        ...
        var stage = Path.Combine(Path.GetTempPath(), $"nutest-extension-{Guid.NewGuid():N}");
        ...
        try
        {
            ...
            if (root.ValueKind != JsonValueKind.Object ||
                ...
                root.GetProperty("$schema").GetString() !=
                    "https://schemas.nutestserver.dev/extensions/package/v1" ||
        ...
        string packageVersion)
    {
        ...
        var forbidden = references.FirstOrDefault(reference =>
            ...
            (reference.Name.StartsWith("NuGet.TestServer.", StringComparison.Ordinal) &&
