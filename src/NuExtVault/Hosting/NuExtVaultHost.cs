...
public sealed class NuExtVaultHost : IAsyncDisposable
{
    private readonly WebApplication _application;

    private NuExtVaultHost(
    ...
    public static async Task<NuExtVaultHost> StartAsync(
        CancellationToken token = default)
    {
        return await StartAsync(AuthenticationConfiguration.Anonymous, token);
    }

    public static async Task<NuExtVaultHost> StartProductionAsync(
    ...
    internal static async Task<NuExtVaultHost> StartCompositionAsync(
        ServerComposition composition,
